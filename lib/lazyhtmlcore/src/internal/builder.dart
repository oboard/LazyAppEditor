...
class BuildTree extends core_data.BuildTree {
  ...
  void addBitsFromNodes(BuildContext context, dom.NodeList domNodes) {
    for (final domNode in domNodes) {
      _addBitsFromNode(context, domNode);
    }
  ...
  void _addBitsFromNode(BuildContext context, dom.Node domNode) {
    ...
    subTree.addBitsFromNodes(context, element.nodes);
  ...
  void _collectMetadata(BuildContext context, BuildMetadata meta) {
    wf.parse(context, meta);
