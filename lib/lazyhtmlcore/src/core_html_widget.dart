...
class AppletWidget extends StatefulWidget {
  ...
  /// The custom [LazyWidgetFactory] builder.
  final LazyWidgetFactory Function()? factoryBuilder;
  ...
  @override
  State<AppletWidget> createState() => _AppletWidgetState();
}

class _AppletWidgetState extends State<AppletWidget> {
  Widget? _cache;
  Future<Widget>? _future;
  late BuildMetadata _rootMeta;
  late _RootTsb _rootTsb;
  late LazyWidgetFactory _wf;
  ...
  void initState() {
    ...
    _wf = widget.factoryBuilder?.call() ?? LazyWidgetFactory();
  ...
  @override
  void didUpdateWidget(AppletWidget oldWidget) {
  ...
  Future<Widget> _buildAsync() async {
    ...
    final built = _buildBody(context, this, domNodes);
    Timeline.finishSync();
...
class _RootTsb extends TextStyleBuilder {
  ...
  _RootTsb(_AppletWidgetState state) {
  ...
  TextStyleHtml builder(TextStyleHtml? _, _AppletWidgetState state) {
...
Widget _buildBody(
    BuildContext context, _AppletWidgetState state, dom.NodeList domNodes) {
  ...
  final tree = builder.BuildTree(
    ...
    tsb: rootMeta.tsb,
    wf: wf,
  )..addBitsFromNodes(context, domNodes);
